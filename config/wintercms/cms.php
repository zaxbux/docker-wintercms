...
return [
    ...
    */
    ...
    'backendForceRemember' => env('CMS_BACKEND_FORCE_REMEMBER', true),
    ...
    */
    ...
    'backendTimezone' => env('CMS_BACKEND_TZ', 'UTC'),
    ...
    */
    ...
    'disablePlugins' => explode(',', env('CMS_DISABLE_PLUGINS', '')),
    ...
    */
    ...
    'pluginsPath' => env('CMS_PLUGINS_PATH', '/plugins'),
    ...
    */
    ...
    'themesPath' => env('CMS_THEMES_PATH', '/themes'),
    ...
    */
    ...
    'storage' => [
        ...
        'uploads' => [
            'disk'            => env('CMS_UPLOADS_DISK', 'local'),
            'folder'          => env('CMS_UPLOADS_FOLDER', 'uploads'),
            'path'            => env('CMS_UPLOADS_PATH', '/storage/app/uploads'),
        ...
        'resized' => [
            'disk'   => env('CMS_RESIZED_DISK', 'local'),
            'folder' => env('CMS_RESIZED_FOLDER', 'resized'),
            'path'   => env('CMS_RESIZED_PATH', '/storage/app/resized'),
        ],
    ...
    */
    ...
    'convertLineEndings' => env('CMS_CONVERT_LINE_ENDINGS', false),
    ...
    */
    ...
    'defaultMask' => [
        'file'   => env('CMS_DEFAULT_MASK_FILE', null),
        'folder' => env('CMS_DEFAULT_MASK_FOLDER', null)
    ],
